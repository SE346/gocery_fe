...
class _AddCouponScreenState extends State<AddCouponScreen> {
  ...
  void initState() {
    super.initState();
    valueFromDate = DateFormat('dd/MM/yyyy').format(DateTime.now());
    valueEndDate = valueFromDate;
  }
                        ...
                        showDatePicker(
                          ...
                          setState(() {
                            if (value != null) {
                              ...
                              fromDateController.text = valueFromDate;
                            }
                          });
                        });
                      },
                        ...
                        showDatePicker(
                          ...
                          setState(() {
                            if (value != null) {
                              valueEndDate =
                                  DateFormat('dd/MM/yyyy').format(value);
                              endDateController.text = valueEndDate;
                            }
                          });
                        });
                      },
